...
class FieldNormalizer:
    def __init__(self):
        ...
        self.ats_schema = {
            ...
            "curr_location": ["location", "place", "current_location"],
            "education": ["college", "university", "institute", "institution", "school"],
...
class DataNormalizer:
    def __init__(self):
        ...
        self.field_aliases = {
            ...
            "Data Science": ["ds", "data analytics", "data science and ai", "data science and artificial intelligence"],
